...
As a final note, we can also examine the effective dimensionality of the random effects with PCA. The property `rePCA` displays the cumulative variance explained for each principle component of each variance component and thus an estimate of excess dimensionality:
