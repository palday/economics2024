...
If your receive a precompilation error for RCall or JellyMe4, you won't be able to use those packages, but should be able complete all other exmaples. The most likely cause of the precompilation error is a problem with RCall's configuration for using R from within Julia.
